...
vim.opt.incsearch = true -- update search results as you type
...
-- ignore modelines (config settings) at the top and bottom of the file
vim.opt.modeline = false

-- allow 24 bit color rather than limit to 256
...
-- connect OS and vim clipboard
-- does not work yet
vim.o.clipboard = "unnamedplus"

-- reduce update time for the benefit of LSP and other analytic plugins
vim.o.updatetime = 250

-- stop multi-key sequence mappings from timing out
vim.o.timeout = false

-- don't have the cursor more than 8 characters from the bottom / top of screen
vim.opt.scrolloff = 8

-- makes it so the text does not shift from left to right in insert / normal mode
vim.opt.signcolumn = "yes"

-- make it so that we can see more that >99/>99 in the search
vim.opt.shortmess:remove("S")

-- disable the mouse
vim.opt.mouse = ""

-- Stop the <Space> key from moving the cursor forward
vim.api.nvim_set_keymap("n", "<Space>", "<NOP>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<Space>", "<NOP>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("o", "<Space>", "<NOP>", { noremap = true, silent = true })
		...
		config = function()
			require("lualine").setup({
				...
				sections = {
					...
					lualine_b = { "branch" },
					lualine_c = {
						{ "filename", path = 1 }, -- 'path = 1' shows the relative file path
						-- use 'path = 3' to show the absolute file path
					},
